...
#define STRING_CONFIG_H_AUTHOR "(KP, 1.1)" // Who made the changes. 1.1 = enabled bluetooth
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 220.88
    #define  DEFAULT_bedKi 15.46
    #define  DEFAULT_bedKd 788.90
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.00,80.00,4000.00,700}  // default steps per unit for Ultimaker
